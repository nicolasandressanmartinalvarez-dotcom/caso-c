    ...
    const cargarDatos = async () => {
        ...
        try {
            ...
            if (!usuarioActual || !usuarioActual.municipalidad?.id) {
                setError("El usuario no tiene una municipalidad asignada o no está permitido.");
                setMascotas([]);
        ...
        <section className={ListarMascotasCss["contenedor-lista"]}>
            <div className={ListarMascotasCss["header-lista"]}>
                <div className={ListarMascotasCss["titulo-seccion"]}>
                    <h2>Directorio de Mascotas de tu Municipalidad 🐾</h2>
                    <p>Explora y filtra las mascotas reportadas en tu municipalidad.</p>
                </div>
            </div>
            ...
            {error ? (
                ...
                <div className={ListarMascotasCss["grid-mascotas"]}>
                    {mascotas.length === 0 ? (
                        <p style={{ gridColumn: "1 / -1", textAlign: "center" }}>No hay mascotas registradas para tu municipalidad.</p>
                    ) : (
                        mascotas.map((mascota) => (
                            <div className={ListarMascotasCss["card-mascota"]} key={mascota.id}>
                                <div className={ListarMascotasCss["card-imagen-container"]}>
                                    <img 
                                        src={mascota.imagen ? `http://localhost:8080/imagenes/${mascota.imagen}` : IMAGEN_DEFAULT} 
                                        alt={mascota.nombre} 
                                ...
                                <div className={ListarMascotasCss["card-body"]}>
                                    ...
                                    <ul className={ListarMascotasCss["mascota-detalles"]}>
                                        ...
                                        <li><strong>Municipalidad:</strong> {nombreEntidad}</li>
                                    </ul>
                                </div>
                    ...
                    <div className={ListarMascotasCss["modal-content"]} onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className={ListarMascotasCss["modal-grid"]}>
                            <div className={ListarMascotasCss["modal-imagen-box"]}>
                                <img 
                                    src={mascotaSeleccionada.imagen ? `http://localhost:8080/imagenes/${mascotaSeleccionada.imagen}` : IMAGEN_DEFAULT} 
                            ...
                            <div className={ListarMascotasCss["modal-info-box"]}>
                                ...
                                <div className={ListarMascotasCss["modal-tags"]}>
                                    ...
                                    <p><strong>Municipalidad:</strong> {nombreEntidad}</p>
                                </div>
...
export default ListarMascotasMuni;
