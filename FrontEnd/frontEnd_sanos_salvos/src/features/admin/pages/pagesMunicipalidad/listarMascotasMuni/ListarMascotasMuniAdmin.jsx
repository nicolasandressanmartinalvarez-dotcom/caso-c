...
import ListarMascotasCss from './ListarMascotasMuniAdmin.module.css';
...
function ListarMascotasMuniAdmin() {
        ...
        <section className={ListarMascotasCss["contenedor-lista"]}>
            <div className={ListarMascotasCss["header-lista"]}>
                <div className={ListarMascotasCss["titulo-seccion"]}>
                    <h2>Directorio de Mascotas Municipalidad 🐾</h2>
                    <p>Explora y filtra las mascotas reportadas por la Municipalidad.</p>
                </div>
            </div>
                ...
                mascotas.map((mascota) => (
                    <div className={ListarMascotasCss["card-mascota"]} key={mascota.id}>
                        <div className={ListarMascotasCss["card-imagen-container"]}>
                            <img src={mascota.imagen ? `http://localhost:8080/imagenes/${mascota.imagen}` : IMAGEN_DEFAULT} alt={mascota.nombre} className={ListarMascotasCss["card-imagen"]} />
                        ...
                        <div className={ListarMascotasCss["card-body"]}>
                            ...
                            <ul className={ListarMascotasCss["mascota-detalles"]}>
                                ...
                                <li><strong>Municipalidad:</strong> {mascota.municipalidad ? mascota.municipalidad.nombreMuni : "No asignada"}</li>
                            </ul>
                        </div>
                    ...
                    <div className={ListarMascotasCss["modal-content"]} onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className={ListarMascotasCss["modal-grid"]}>
                            <div className={ListarMascotasCss["modal-imagen-box"]}>
                                <img src={mascotaSeleccionada.imagen ? `http://localhost:8080/imagenes/${mascotaSeleccionada.imagen}` : IMAGEN_DEFAULT} alt={mascotaSeleccionada.nombre} />
                            ...
                            <div className={ListarMascotasCss["modal-info-box"]}>
                                ...
                                <div className={ListarMascotasCss["modal-tags"]}>
                                    ...
                                    <span className={ListarMascotasCss["tag"]}>Municipalidad: {mascotaSeleccionada.municipalidad ? mascotaSeleccionada.municipalidad.nombreMuni : "No asignada"}</span>
                                </div>
...
export default ListarMascotasMuniAdmin;
